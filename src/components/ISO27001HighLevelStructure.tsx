...
import { ArrowRight, ChevronDown, ChevronUp, Building2, Users, Target, Zap, Shield, BarChart3, RefreshCw } from "lucide-react";

const ISO27001HighLevelStructure: React.FC = () => {
  ...
  const sections = [
    {
      ...
      phase: "Plan",
      icon: Building2,
      color: "bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-blue-300/50 text-blue-800",
      hoverColor: "hover:from-blue-100 hover:via-indigo-100 hover:to-purple-100 hover:border-blue-400",
      subsections: [
    ...
    },
    {
      ...
      phase: "Act",
      icon: RefreshCw,
      color: "bg-gradient-to-br from-rose-50 via-pink-50 to-red-50 border-rose-300/50 text-rose-800",
      hoverColor: "hover:from-rose-100 hover:via-pink-100 hover:to-red-100 hover:border-rose-400",
      subsections: [
  ...
  const phaseColors = {
    Plan: "bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 shadow-lg shadow-blue-200",
    Do: "bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 shadow-lg shadow-emerald-200", 
    Check: "bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-500 shadow-lg shadow-amber-200",
    Act: "bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 shadow-lg shadow-rose-200"
  };
    ...
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="text-center mb-10">
        <div className="inline-block p-6 bg-gradient-to-br from-slate-50 via-white to-blue-50 rounded-2xl shadow-lg border border-gray-100 mb-4">
          ...
          <p className="text-gray-600 text-sm max-w-md mx-auto leading-relaxed">
            Plan-Do-Check-Act Framework for Information Security Management Systems
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-white via-gray-50/50 to-slate-50/30 rounded-2xl shadow-2xl border border-gray-200/50 p-8 backdrop-blur-sm">
        ...
        <div className="flex justify-center items-center space-x-4 mt-8 pt-6 border-t border-gray-300/50">
          <div className="flex items-center space-x-3 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-full border border-blue-200/50">
          ...
          <div className="flex items-center space-x-3 px-4 py-2 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-full border border-emerald-200/50">
            ...
            <span className="text-sm font-medium text-emerald-700">Do</span>
          </div>
          <ArrowRight className="h-4 w-4 text-gray-400" />
          <div className="flex items-center space-x-3 px-4 py-2 bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-full border border-amber-200/50">
            ...
            <span className="text-sm font-medium text-amber-700">Check</span>
          </div>
          <ArrowRight className="h-4 w-4 text-gray-400" />
          <div className="flex items-center space-x-3 px-4 py-2 bg-gradient-to-r from-rose-500/10 to-red-500/10 rounded-full border border-rose-200/50">
            <div className="w-3 h-3 bg-gradient-to-r from-rose-500 to-red-500 rounded-full shadow-sm"></div>
            <span className="text-sm font-medium text-rose-700">Act</span>
          </div>
        </div>
      </div>
      ...
      <div className="text-center mt-6">
        <div className="inline-block px-6 py-3 bg-gradient-to-r from-slate-50 to-gray-50 rounded-full border border-gray-200/50 shadow-sm">
          <p className="text-sm text-gray-600">
            ...
            <span className="text-gray-500 font-medium">Expert Information Security Consulting</span>
          </p>
        </div>
      </div>
    </div>
...
export default ISO27001HighLevelStructure;
